...
public class Employee {
  ...
  /**
   * @param argempI to set Employee's ID.
  ...
  public Employee(final int argempI, final String argempFullName,
   ...
   */
  public final void setEmpName(final String argempFullName) {
    this.empFullName = argempFullName;
  }
   ...
   */
  public final Date getdatejoining() {
   ...
   */
  public final void setJoinig(final Date argdateOfJoining) {
    this.dateOfJoining = argdateOfJoining;
  }
   ...
   */
  public final void setavlLeave(final int argavailableLeave) {
    this.availableLeave = argavailableLeave;
  }
...
<<<<<<< HEAD
 ...
 /**
   ...
   * @return Status
   */
  public static String appDenyDecrement(final int empID, final int leaveTaken) {
    dao().appDenyDecrement(empID, leaveTaken);
    return "Leave Balance Updated";
  }
