...
public class CliMain {
  ...
  private void pendingLeaves() {
    ...
    for (LeaveDetails e : pending) {
      System.out.println(e.getleaveid() + " " + e.getempid() + " "
          ...
          + e.getleavetype() + " " + e.leavestatus() + " " + e.getleavereason()
  ...
  */
  ...
  private void applyLeave() {
    ...
    System.out.println();
    System.out.println("Your available leave balance is: " + Employee.listById(empid).getavlLeave());
    String endDate = null;
    ...
    while (true) {
      ...
      try {
        ...
        System.out.println(employee.getEmpId() + " " + employee.getName() + " "
              + employee.getemailId() + " " + employee.getMobNumber() + " " + employee.getdatejoining() + " "
              + employee.getDepartment() + " " + employee.getavlLeave() + " " + employee.getMgrId());
        break;
      } catch (NumberFormatException nfe) {
        System.out.println("-------------------------------------------");
        System.out.println("-----please enter correct employee id------");
  ...
  private void listEmployeesDetails() {
    ...
    for (Employee e : employee) {
      System.out.println(e.getEmpId() + " " + e.getName() + " "
          + e.getemailId() + " " + e.getMobNumber() + " " + e.getdatejoining() + " "
          + e.getDepartment() + " " + e.getavlLeave() + " " + e.getMgrId());
    }
  }
